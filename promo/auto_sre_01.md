...
This demo shows an AI-assisted remediation workflow:

• Run a cloud audit on demand or on a schedule
• Findings are published as structured data
• AI analyses the findings and generates remediation code
• A remediation pull request is opened automatically
• A human reviews and approves the change
• The fix is merged and applied

The interesting part isn't the audit.

The interesting part is the AI-generated remediation PR.
...
The AI doesn't get production access.
...
[auto@stackql.io](mailto:auto@stackql.io)

#sre #devops #platformengineering #finops #cloud #githubactions #opensource #ai
