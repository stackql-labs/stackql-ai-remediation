(a) This removes the unattached EBS volume `vol-08ba9f209b2b8a11b` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
