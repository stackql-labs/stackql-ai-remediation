(a) This removes the unattached EBS volume `vol-0ab197e934110fcc9` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
