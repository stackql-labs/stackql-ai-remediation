(a) This removes the unattached EBS volume `vol-0e620fc9c3b6d55db` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
