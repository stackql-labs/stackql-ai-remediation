(a) This removes the unattached EBS volume `vol-003cc7ab19db52a16` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
