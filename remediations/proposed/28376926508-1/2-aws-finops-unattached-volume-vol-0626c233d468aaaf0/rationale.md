(a) This removes the unattached EBS volume `vol-0626c233d468aaaf0` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
