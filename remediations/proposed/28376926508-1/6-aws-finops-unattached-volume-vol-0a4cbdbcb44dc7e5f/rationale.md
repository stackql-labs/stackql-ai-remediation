(a) This removes the unattached EBS volume `vol-0a4cbdbcb44dc7e5f` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
