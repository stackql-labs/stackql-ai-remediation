(a) This removes the unattached EBS volume `vol-0ca8412179b80723c` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
