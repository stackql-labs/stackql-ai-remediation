(a) This removes the unattached EBS volume `vol-077beae6eaa6dfe77` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
