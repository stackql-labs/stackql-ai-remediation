(a) This removes the unattached EBS volume `vol-0d2a256d3e79ae0d5` (gp2, 1 GiB) in region `ap-southeast-2` via a StackQL `DELETE` against `aws.ec2.volumes`.
